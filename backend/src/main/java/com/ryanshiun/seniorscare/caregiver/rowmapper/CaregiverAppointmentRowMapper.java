...
public class CaregiverAppointmentRowMapper implements RowMapper<CaregiverAppointment> {
    ...
    public CaregiverAppointment mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        // 建立者資訊
        appointment.setCreatedByType(rs.getString("created_by_type"));
        appointment.setCreatedByMemberId(rs.getObject("created_by_member_id", Integer.class));
        appointment.setCreatedByEmployeeId(rs.getObject("created_by_employee_id", Integer.class));
