          ...
          >
            ...
            <div class="w-full md:w-auto md:flex-1 overflow-auto">
              ...
              >
                ...
                <div class="flex items-center justify-between mb-6">
                  <div class="flex items-center gap-4">
                    ...
                    >
                      ...
                      <i
                        v-else
                        class="fa-solid fa-user text-primary text-2xl"
                      ></i>
                      <!-- [重點] Line 同步標示 -->
                      <div
                ...
                <p
                  class="text-base sm:text-lg mb-8 text-justify text-gray-600 dark:text-gray-300"
                >
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                  ...
                  <div class="space-y-4">
                    ...
                    <div class="space-y-3">
                      ...
                      >
                        ...
                        <div class="flex-1">
                          <div class="flex items-center gap-2">
                            ...
                            <i
                              class="fa-solid fa-edit text-primary text-xs opacity-60"
                            ></i>
                          </div>
                          <!-- [重點] 顯示模式 -->
                          <p
                      ...
                      <!-- [重點] 手機號碼 - 可編輯 -->
                      <div
                        class="flex items-center gap-3 p-3 bg-white dark:bg-title rounded-lg"
                      >
                        <div
                          class="w-8 h-8 bg-primary/10 rounded-full flex items-center justify-center flex-none"
                        >
                      ...
                      >
                        ...
                        >
                          <i
                            class="fa-solid fa-envelope text-primary text-sm"
                          ></i>
                        </div>
                        <div class="flex-1">
                          <div class="flex items-center gap-2">
                      ...
                      >
                        ...
                        >
                          <i
                            class="fa-solid fa-location-dot text-primary text-sm"
                          ></i>
                        </div>
                        <div class="flex-1">
                          <div class="flex items-center gap-2">
                  ...
                  <div class="space-y-4">
                    ...
                    <div class="space-y-3">
                      ...
                      >
                        ...
                        >
                          <i
                            class="fa-solid fa-venus-mars text-primary text-sm"
                          ></i>
                        </div>
                        <div class="flex-1">
                          <div class="flex items-center gap-2">
                      ...
                      >
                        ...
                        >
                          <i
                            class="fa-solid fa-birthday-cake text-primary text-sm"
                          ></i>
                        </div>
                        <div class="flex-1">
                          <div class="flex items-center gap-2">
                      ...
                      >
                        ...
                        <div class="flex-1">
                          <div class="flex items-center gap-2">
                            ...
                            <i
                              class="fa-solid fa-lock text-gray-400 text-xs"
                            ></i>
                          </div>
                          <p
                  ...
                  <div class="space-y-4 md:col-span-2">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      ...
                      >
                        ...
                        >
                          <i
                            class="fa-solid fa-calendar-plus text-green-600 dark:text-green-400 text-sm"
                          ></i>
                        </div>
                        <div class="flex-1">
                          <div class="flex items-center gap-2">
                      ...
                      >
                        ...
                        >
                          <i
                            class="fa-solid fa-calendar-check text-blue-600 dark:text-blue-400 text-sm"
                          ></i>
                        </div>
                        <div class="flex-1">
                          <div class="flex items-center gap-2">
                      ...
                      >
                        ...
                        >
                          <i
                            class="fa-solid fa-sign-in-alt text-orange-600 dark:text-orange-400 text-sm"
                          ></i>
                        </div>
                        <div class="flex-1">
                          <div class="flex items-center gap-2">
...
function fillEditForm() {
  if (memberData.value) {
    editForm.value = {
      ...
      // [重點] 修復性別轉換邏輯
      gender:
        memberData.value.gender === "男"
          ? "true"
          : memberData.value.gender === "女"
          ? "false"
          : "",
      // [重點] 使用 memberService 的日期轉換函數
      birthday: memberService.convertDateForInput(
        memberData.value.birthdayRaw || memberData.value.birthday
      ),
